...
export const metadata: Metadata = {
  title: "O nás",
  description:
    "Kdo jsme, jak pomáháme a proč existuje iniciativa Hlas proti drogám. Naše mise, hodnoty a tým.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="#mission"
                  className="px-5 py-2.5 rounded-md bg-orange-600 text-white hover:bg-orange-700 transition"
                >
                  Naše mise
                </a>
                <a
                  href="#values"
                  className="px-5 py-2.5 rounded-md border border-orange-300 text-orange-700 bg-white hover:bg-orange-50 transition"
                >
                  Naše hodnoty
                </a>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-16 space-y-20">
        ...
        >
          ...
          {[
            ...
            <div
              key={s.label}
              className="bg-white rounded-2xl border border-orange-200 p-6 shadow-sm text-center"
            >
        ...
        >
          <div className="lg:col-span-2 space-y-6">
            <h2 id="mission-title" className="text-3xl font-bold text-gray-900">
              Naše mise
            </h2>
            <p className="text-gray-700 leading-relaxed">
              ...
              materiály a komunitní aktivity, které posilují odolnost a snižují
              riziko prvního kontaktu s návykovými látkami. Naše práce stojí na
              principech respektu, partnerství a otevřené komunikace.
            </p>
          ...
          <aside className="space-y-4">
            <div className="bg-white rounded-2xl border border-orange-200 p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-700 mb-4">
                Každý dar nám pomáhá rozšiřovat prevenční programy a dostupnost
                pomoci.
              </p>
              <QRDonate />
            </div>
            <div className="rounded-2xl border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-700">
                Máte zájem o workshop ve škole nebo firemní program? Napište nám
                přes formulář v sekci Kontakt.
              </p>
            </div>
          </aside>
        </section>
        ...
        <section
          ...
          className="space-y-6"
        >
          <h2 id="values-title" className="text-3xl font-bold text-gray-900">
            Naše hodnoty
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Respekt",
                desc: "Jednáme s úctou a chápeme různorodé životní situace.",
              },
              {
                title: "Otevřenost",
                desc: "Věříme v transparentní komunikaci a sdílení zkušeností.",
              },
              {
                title: "Spolupráce",
                desc: "Propojujeme odborníky, školy a komunity do jednoho celku.",
              },
            ].map((v) => (
              <div
                key={v.title}
        ...
        <section aria-labelledby="timeline-title" className="space-y-6">
          <h2 id="timeline-title" className="text-3xl font-bold text-gray-900">
          ...
          <ol className="relative border-s border-gray-200 space-y-8 ps-6">
            <li>
              ...
              <h3 className="font-semibold text-gray-900">
                2019 – Založení iniciativy
              </h3>
              <p className="text-sm text-gray-700">
                Skupina dobrovolníků spouští první přednášky a osvětové kampaně.
              </p>
            </li>
            <li>
              <div className="absolute -start-1.5 mt-1.5 h-3 w-3 rounded-full bg-orange-500" />
              <h3 className="font-semibold text-gray-900">
                2021 – Rozšíření do regionů
              </h3>
              <p className="text-sm text-gray-700">
                Vznikají regionální týmy a spolupráce se školami a neziskovkami.
              </p>
            </li>
            <li>
              <div className="absolute -start-1.5 mt-1.5 h-3 w-3 rounded-full bg-orange-500" />
              <h3 className="font-semibold text-gray-900">
                2024 – Online platforma
              </h3>
              <p className="text-sm text-gray-700">
                Spouštíme online materiály, webináře a vzdělávací balíčky pro
                školy.
              </p>
            </li>
          </ol>
        ...
        <section aria-labelledby="team-title" className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                name: "Denis Z.",
                role: "Koordinátor prevence",
                img: "/images/Denis.png",
              },
              {
                name: "Jana K.",
                role: "Lektorka",
                img: "/images/marihuanaD.png",
              },
              { name: "Petr S.", role: "Analytik", img: "/images/heroin.png" },
              {
                name: "Eliška M.",
                role: "Komunitní podpora",
                img: "/images/pervitin.png",
              },
            ].map((m) => (
              <div
                key={m.name}
