      ...
      <section className="bg-[#F58549] relative">
        ...
        <div className="flex flex-col items-center text-center pb-16 px-4">
          ...
          <p className="text-lg md:text-xl text-[#FFF3E0] mb-6 max-w-2xl drop-shadow-md">
            Tvůj život, tvoje volba – řekni drogám NE.
          </p>
          <Link
            href="/aboutUs"
            className="bg-[#FB8B24] hover:bg-[#E36414] text-white px-6 py-3 rounded-full transition-all shadow-lg transform hover:scale-105"
          >
            Zjistit více
          </Link>
        </div>
      ...
      <section className="py-24 bg-linear-to-b from-white to-[#FFF4EA]">
        <div className="max-w-7xl mx-auto px-4 space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-5xl font-extrabold text-gray-800 leading-tight">
                Drogy ničí budoucnost{" "}
                <span className="text-[#F58549]">rychleji</span>, než si myslíš
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                Závislost není slabost. Je to past, do které může spadnout
                kdokoliv. Čím dřív to pochopíš, tím větší máš kontrolu nad svým
                životem.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="bg-white rounded-3xl shadow-xl p-10 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600">
                Drogy narušují přirozenou chemii mozku a vytváří falešný pocit
                štěstí.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600">
                1 z 5 mladých lidí se setká s drogami ještě před 18. rokem
                života.
              </p>
            </div>
          ...
          <div className="bg-[#F58549] rounded-3xl p-14 text-white text-center shadow-2xl mb-16">
            <h3 className="text-4xl font-extrabold mb-4">Chceš vědět víc?</h3>
            <p className="text-lg text-[#FFF3E0] mb-8 max-w-2xl mx-auto">
              Nauč se, jak se chránit, jak pomoci kamarádům a jak mít kontrolu
              nad svým životem.
            </p>
            <Link
              href="/aboutUs"
